        ...
        <div class="col-md-6">
          <form method="post" action="add_provider.php">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="address" placeholder="Direccion del proveedor">
            </div>
         
            <div class="form-group">
                <label for="phone">Telefono</label>
                <input type="phone" class="form-control" name ="phone"  placeholder="Telefono Proveedor">
            </div>   
