...
<?php
 if(isset($_POST['add_product'])){
   ...
   if(empty($errors)){
     ...
     $p_cat   = remove_junk($db->escape($_POST['product-categorias']));
     $p_qty   = remove_junk($db->escape($_POST['Cantidad']));
     $p_buy   = remove_junk($db->escape($_POST['PrecioCompra']));
     $p_sale  = remove_junk($db->escape($_POST['PrecioSalida']));
     ...
     $query .=" NombreProducto,Cantidad,PrecioCompra,PrecioSalida,categorias_id,media_id,fecha";
     $query .=") VALUES (";
